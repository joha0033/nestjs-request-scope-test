...
export class BenchmarkComparisonService {
  async runAutocannon(
    ...
    return new Promise((resolve, reject) => {
      ...
      const args = [
        ...
        body,
        '--connections',
        (options.connections || 10).toString(),
        '--pipelining',
        (options.pipelining || 1).toString(),
        '--duration',
        (options.duration || 10).toString(),
        url,
      ];
  ...
  private printComparisonTable(
    result1: AutocannonResult,
    result2: AutocannonResult,
  ): void {
    ...
    console.log(
      `│   Latency   │ ${formatMs(result1.latency.p2_5).padEnd(11)} │ ${formatMs(result1.latency.p50).padEnd(11)} │ ${formatMs(result1.latency.p97_5).padEnd(11)} │ ${formatMs(result1.latency.p99).padEnd(11)} │ ${formatMs(result1.latency.average).padEnd(11)} │ ${formatMs(result1.latency.stddev).padEnd(11)} │ ${formatMs(result1.latency.max).padEnd(11)} │`,
    );
    console.log(
      '├─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┤',
    );
    ...
    console.log(
      `│   Req/Sec   │ ${formatReq(result1.requests.p1).padEnd(11)} │ ${formatReq(result1.requests.p2_5).padEnd(11)} │ ${formatReq(result1.requests.p50).padEnd(11)} │ ${formatReq(result1.requests.p97_5).padEnd(11)} │ ${formatReq(result1.requests.average).padEnd(11)} │ ${formatReq(result1.requests.stddev).padEnd(11)} │ ${formatReq(result1.requests.min).padEnd(11)} │`,
    );
    console.log(
      `│ Bytes/Sec   │ ${formatMB(result1.throughput.p2_5).padEnd(11)} │ ${formatMB(result1.throughput.p50).padEnd(11)} │ ${formatMB(result1.throughput.p97_5).padEnd(11)} │ ${formatMB(result1.throughput.p99).padEnd(11)} │ ${formatMB(result1.throughput.average).padEnd(11)} │ ${formatKB(result1.throughput.stddev).padEnd(11)} │ ${formatMB(result1.throughput.min).padEnd(11)} │`,
    );
    console.log(
      '└─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┘',
    );
    ...
    console.log(
      `│   Latency   │ ${formatMs(result2.latency.p2_5).padEnd(11)} │ ${formatMs(result2.latency.p50).padEnd(11)} │ ${formatMs(result2.latency.p97_5).padEnd(11)} │ ${formatMs(result2.latency.p99).padEnd(11)} │ ${formatMs(result2.latency.average).padEnd(11)} │ ${formatMs(result2.latency.stddev).padEnd(11)} │ ${formatMs(result2.latency.max).padEnd(11)} │`,
    );
    console.log(
      '├─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┼─────────────┤',
    );
    ...
    console.log(
      `│   Req/Sec   │ ${formatReq(result2.requests.p1).padEnd(11)} │ ${formatReq(result2.requests.p2_5).padEnd(11)} │ ${formatReq(result2.requests.p50).padEnd(11)} │ ${formatReq(result2.requests.p97_5).padEnd(11)} │ ${formatReq(result2.requests.average).padEnd(11)} │ ${formatReq(result2.requests.stddev).padEnd(11)} │ ${formatReq(result2.requests.min).padEnd(11)} │`,
    );
    console.log(
      `│ Bytes/Sec   │ ${formatMB(result2.throughput.p2_5).padEnd(11)} │ ${formatMB(result2.throughput.p50).padEnd(11)} │ ${formatMB(result2.throughput.p97_5).padEnd(11)} │ ${formatMB(result2.throughput.p99).padEnd(11)} │ ${formatMB(result2.throughput.average).padEnd(11)} │ ${formatKB(result2.throughput.stddev).padEnd(11)} │ ${formatMB(result2.throughput.min).padEnd(11)} │`,
    );
    console.log(
      '└─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┴─────────────┘',
    );
  ...
  private printSummary(
    ...
    const throughputDiff =
      ((result1.requests.average - result2.requests.average) /
        result2.requests.average) *
      100;
    const throughputWinner =
      result1.requests.average > result2.requests.average ? 'Test 1' : 'Test 2';
    console.log(`🚀 Throughput: ${throughputWinner} wins`);
    console.log(
      `   Test 1: ${result1.requests.average.toLocaleString()} req/s`,
    );
    console.log(
      `   Test 2: ${result2.requests.average.toLocaleString()} req/s`,
    );
    console.log(`   Difference: ${Math.abs(throughputDiff).toFixed(1)}%\n`);

    // Latency comparison
    const latencyDiff =
      ((result1.latency.average - result2.latency.average) /
        result2.latency.average) *
      100;
    const latencyWinner =
      result1.latency.average < result2.latency.average ? 'Test 1' : 'Test 2';
    ...
    const consistencyWinner =
      result1.latency.stddev < result2.latency.stddev ? 'Test 1' : 'Test 2';
    ...
    const transferDiff =
      ((result1.throughput.average - result2.throughput.average) /
        result2.throughput.average) *
      100;
    ...
    console.log(
      `   Test 1: ${(result1.throughput.average / 1024 / 1024).toFixed(2)} MB/s`,
    );
    console.log(
      `   Test 2: ${(result2.throughput.average / 1024 / 1024).toFixed(2)} MB/s`,
    );
    ...
    const totalDiff =
      ((result1.requests.total - result2.requests.total) /
        result2.requests.total) *
      100;
    const totalWinner =
      result1.requests.total > result2.requests.total ? 'Test 1' : 'Test 2';
    console.log(`📋 Total Work: ${totalWinner} wins`);
    console.log(
      `   Test 1: ${result1.requests.total.toLocaleString()} total requests`,
    );
    console.log(
      `   Test 2: ${result2.requests.total.toLocaleString()} total requests`,
    );
